...
# DBTITLE 1,CSV file contains links to narrative summaries of reasons for listing
import csv
from pyspark.sql.functions import col

csv_filepath = "/Volumes/main/default/example-data/links.csv"

link_sdf = spark.read.csv(csv_filepath, header=True)  # .sort(col("ref_num").desc())
...
# print(nodestring_list, len(nodestring_list))
# print(new_link_list, len(new_link_list))
# links = node['links']
# print(node['id'], len(links), links)
# if len(links) <= 1 :
#     continue
